package com.sfw.anno.smallupdate.app.main;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Small.openUri("next",MainActivity.this);
            }
        });
        update = (Button)findViewById(R.id.testUpdate);
    ...
    private void checkUpgrade() {
        new UpgradeManager(MainActivity.this).checkUpgrade();
    }
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        URL url = new URL("https://raw.githubusercontent.com/shufengwu/small_server/master/bundle.json");
